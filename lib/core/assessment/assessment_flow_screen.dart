...
class _AssessmentFlowScreenState extends State<AssessmentFlowScreen> {
  ...
  int _estimatedTotalSteps() {
    // A simple dynamic estimate to make progress feel correct.
    // Base gates: 4
    // Then one module: 2 (wb/anx/mood)
    // Safety: +1 sometimes
    // => total usually 6–7
    ...
    // If user hasn’t reached module yet, still use est to keep bar smooth
    // but never smaller than current path length
